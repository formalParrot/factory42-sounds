...
8. Everyone can see `/give` and `/take`, but only members with role ID `1551232729444786187` can use them. Unauthorized attempts receive an ephemeral error. `/leaderboard` shows the top balances.
